...
#define IOCON_PIO_ASW0_EN 0x0400u     /*!<@brief Analog switch 0 is closed (enabled) */
...
/*!
 * @brief Configures pin routing and optionally pin electrical features for getting the hardware version.
 *
 */
