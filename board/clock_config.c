...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivCtimer2Clk, 0U, true);            /*!< Reset CTIMER2CLKDIV divider counter and halt it */
    CLOCK_SetClkDiv(kCLOCK_DivCtimer2Clk, 1U, false);           /*!< Set CTIMER2CLKDIV divider to value 1 */
