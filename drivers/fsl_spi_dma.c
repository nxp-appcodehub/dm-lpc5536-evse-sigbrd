...
//            uint32_t new_tx[32] = {0} ;
//                        for( int  i = 0 ; i < 24 ; i++ )
//                        {
//                        	new_tx[i] = (   (  xfer->txData)[i]  ) | kSPI_FrameAssert |kSPI_FrameDelay | SPI_FIFOWR_LEN(15) ;
//                        }
//
//                        DMA_PrepareTransfer(&xferConfig, new_tx , (uint32_t *)address, 4U ,  4U*12,
//                                                       kDMA_MemoryToPeripheral, NULL /*nextDesc*/);
